...
public class BasicCreature extends Creature{
	...
	public BasicCreature(String name, int x_position, int y_position, Map map, Path p){
		super(name, x_position, y_position, new Square(x_position, y_position, 0.5, Color.RED), 1, 1, map, 1.0, 1.0, p);
		hit_box = new Square(x_position, y_position, 10, Color.RED);
		cost = 1;
		health = 1;
		velocity = 60;
